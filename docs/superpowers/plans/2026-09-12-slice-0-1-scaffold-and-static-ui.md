...
Twelve small components, each plain React styled with token utilities. See "Two calls made up front" at the top of this plan for why these are hand-written rather than generated by `shadcn init`.

**Files:**
- Create, under `src/renderer/components/ui/`: `button.tsx`, `icon-button.tsx`, `badge.tsx`, `avatar.tsx`, `progress-track.tsx`, `input.tsx`, `search-field.tsx`, `select-pill.tsx`, `checkbox.tsx`, `switch.tsx`, `tag.tsx`, `filter-chip.tsx`, `skeleton.tsx`
- **`dialog.tsx` is NOT part of this task** — it belongs to Task 15, which specifies its code.
...
- [ ] **Step 1: Write `src/renderer/features/issues/IssueDetailDialog.tsx`**
...
- [ ] **Step 1: Write `src/renderer/features/settings/SettingsScreen.tsx`**
...
- [ ] **Step 1: Write `src/renderer/features/search/SearchScreen.tsx`**
...
- Modify: `src/renderer/App.tsx`, `CLAUDE.md`
